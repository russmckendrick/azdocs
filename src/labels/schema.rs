...
pub struct DesktopLabels {
    ...
    pub regions: DesktopRegionsLabels,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct DesktopRegionsLabels {
    pub title: String,
    pub description: String,
    pub map_aria: String,
    pub legend_active: String,
    pub legend_quiet: String,
    pub column_region: String,
    pub column_geography: String,
    pub column_resources: String,
    pub column_share: String,
    pub open_region: String,
    pub unplaced: String,
    pub empty_title: String,
    pub empty_detail: String,
    pub map_controls_aria: String,
    pub zoom_in: String,
    pub zoom_out: String,
    pub zoom_reset: String,
    pub show_region: String,
    pub detail_aria: String,
    pub close: String,
    ...
    pub zones_available: String,
    pub zones_unavailable: String,
    pub paired_region: String,
    pub opened: String,
    pub status: String,
    pub status_open: String,
    pub status_announced: String,
    pub data_residency: String,
    pub resources_here: String,
    pub open_resources: String,
}
