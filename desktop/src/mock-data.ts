...
export const mockEstate: EstateSnapshot = {
  ...
  azureMetadata: {
    regions: {
      uksouth: { latitude: 50.941, longitude: -0.799, physicalLocation: "London", geography: "United Kingdom", availabilityZones: true, open: true, pairedRegion: "UK West", yearOpened: 2016, dataResidency: "Stored at rest in the United Kingdom" },
      ukwest: { latitude: 51.4816, longitude: -3.1791, physicalLocation: "Cardiff", geography: "United Kingdom", availabilityZones: false, open: true, pairedRegion: "UK South", yearOpened: 2016, dataResidency: "Stored at rest in the United Kingdom" },
      northeurope: { latitude: 53.3478, longitude: -6.2597, physicalLocation: "Ireland", geography: "Europe", availabilityZones: true, open: true, pairedRegion: null, yearOpened: null, dataResidency: null },
      westeurope: { latitude: 52.3667, longitude: 4.9, physicalLocation: "Netherlands", geography: "Europe", availabilityZones: true, open: true, pairedRegion: null, yearOpened: null, dataResidency: null },
      eastus: { latitude: 37.3719, longitude: -79.8164, physicalLocation: "Virginia", geography: "United States", availabilityZones: true, open: true, pairedRegion: null, yearOpened: null, dataResidency: null },
      westus2: { latitude: 47.233, longitude: -119.852, physicalLocation: "Washington", geography: "United States", availabilityZones: true, open: true, pairedRegion: null, yearOpened: null, dataResidency: null },
      southeastasia: { latitude: 1.13, longitude: 105.3, physicalLocation: "Singapore", geography: "Asia Pacific", availabilityZones: true, open: true, pairedRegion: null, yearOpened: null, dataResidency: null },
      australiaeast: { latitude: -33.86, longitude: 151.2094, physicalLocation: "New South Wales", geography: "Australia", availabilityZones: true, open: true, pairedRegion: null, yearOpened: null, dataResidency: null },
      brazilsouth: { latitude: -23.55, longitude: -46.633, physicalLocation: "Sao Paulo State", geography: "Brazil", availabilityZones: true, open: true, pairedRegion: null, yearOpened: null, dataResidency: null },
      southafricanorth: { latitude: -26.2041, longitude: 28.0473, physicalLocation: "Johannesburg", geography: "South Africa", availabilityZones: true, open: true, pairedRegion: null, yearOpened: null, dataResidency: null },
      japaneast: { latitude: 35.68, longitude: 139.77, physicalLocation: "Tokyo", geography: "Japan", availabilityZones: true, open: true, pairedRegion: null, yearOpened: null, dataResidency: null },
      centralindia: { latitude: 18.5822, longitude: 73.9197, physicalLocation: "Pune", geography: "India", availabilityZones: true, open: true, pairedRegion: null, yearOpened: null, dataResidency: null },
    },
    locations: {
      uksouth: "UK South",
      ukwest: "UK West",
