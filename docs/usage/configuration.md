...
strategies, all defined in TOML rather than code. `azure` (the default) carries
the desktop design language into print; `field-report` is the quieter
paper-and-ink alternative. You can add an organisation
