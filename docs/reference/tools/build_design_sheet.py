...
<div class="page">
  ...
  <header style="display: flex; align-items: baseline; gap: 18px; border-bottom: 2px solid {light['ink']}; padding-bottom: 14px; flex-wrap: wrap">
    ...
    <span style="font-size: 12px; font-weight: 600; letter-spacing: 0.14em; text-transform: uppercase; color: {light['faint']}">Field report</span>
...
{scale}
      ...
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; font-size: 12px; color: {light['body']}">
        ...
        <div>
          ...
          <div style="margin-bottom: 6px">Radii: <span class="mono">3px</span> controls &amp; tag chips · <span class="mono">6px</span> panels · fully rounded summary capsules — one purposeful exception to the near-square field-report language</div>
  ...
  <footer style="display: flex; align-items: center; gap: 14px; border-top: 2px solid {light['ink']}; padding-top: 10px; font-size: 11.5px; color: {light['faint']}; flex-wrap: wrap">
    ...
    <span style="margin-left: auto">azdocs · Field Report design language</span>
  </footer>
</div>
</body>
</html>
